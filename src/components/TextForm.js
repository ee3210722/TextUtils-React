...
export default function TextForm(props) {
  ...
  return (
    ...
    <button className="btn btn-primary btn-block mx-1" onClick={handleUpClick}>Convert to Uppercase</button>
    <button className="btn btn-primary btn-block mx-1" onClick={handleLoClick}>Convert to Lowercase</button>
    <button className="btn btn-primary btn-block mx-1" onClick={replacecasefunc}>Replace</button>
    <div className="btn-group mx-1" role="group" aria-label="Basic example">
      ...
      <button type="button" className="btn btn-success" onClick={stop}>Stop</button>
    </div>
    <button className="btn btn-primary btn-block mx-1" onClick={handleExtraSpaces}>HandleExtraSpaces</button>
    <button className="btn btn-primary btn-block mx-1" onClick={clear}>Clear All</button>
